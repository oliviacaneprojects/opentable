...
* Proper usage of UIKit apis (e.g. are cells properly reused, a back button must have a proper title, how well does it scale from iPhone 5s to iPhone Xs Max devices, etc.)
